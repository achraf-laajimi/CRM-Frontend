  ...
  return (
    <div className="fixed top-20 right-[50px] w-64 p-4 bg-white shadow-lg rounded-lg mt-[18px] w-[310px] ">
      <div className="bg-orange-200 rounded-t-lg p-2 flex items-center">
        ...
        <h2 className="ml-2 text-lg font-semibold text-gray-700">Nom-Site</h2>
      </div>
      <div className="p-4 bg-white rounded-b-lg">
        <h3 className="text-2xl font-bold text-gray-900">Bienvenue</h3>
        <p className="text-xl text-gray-500 mt-2 font-semibold mt-5">
          Commencez une conversation avec notre équipe d'experts maintenant!
        </p>
  ...
  const steps={
    ...
    <div className="mt-60px flex justify-end">
      <button
        ...
        className={`${
          isOpen ? 'bg-[#ff6b35] text-white rounded-full w-12 h-12' : 'bg-[#ff6b35] text-white rounded-full px-6 py-3 flex items-center shadow-md hover:bg-[#ff5a1f]'
        }`}
      >
        {isOpen ? (
         <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="stroke ml-[-7px] w-[23px] h-[30px] mt-[-2px]" viewBox="0 0 16 16">
